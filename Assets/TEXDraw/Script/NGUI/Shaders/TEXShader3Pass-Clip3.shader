...
Shader "Hidden/TEXDraw/Default/x18 Samples 3"
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "Hidden/TEXDraw/Default/Full 3/SECONDPASS"
		UsePass "Hidden/TEXDraw/Default/Full 3/THIRDPASS"
		UsePass "Hidden/TEXDraw/Default/Full 3/PRIMARYPASS"
	}
}
...
Shader "Hidden/TEXDraw/Default/x18 Samples 2"
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "Hidden/TEXDraw/Default/Full 2/SECONDPASS"
		UsePass "Hidden/TEXDraw/Default/Full 2/THIRDPASS"
		UsePass "Hidden/TEXDraw/Default/Full 2/PRIMARYPASS"
	}
}
...
{
    [AddComponentMenu("TEXDraw/Supplemets/TEXSup Depth Efffect", 16), ExecuteInEditMode]
    [TEXSupHelpTip("Create a sense of depth by duplicating faces for given iteration times", true)]

...
namespace TexDrawLib
{
    public class MatrixAtom : Atom
    {
        ...
        public override Box CreateBox(TexStyle style)
        {
            ...
            float padding = TEXPreference.main.GetPreference("MatrixMargin", style);
            ...
            var lineThick = TEXPreference.main.GetPreference("LineThickness", style);
        ...
        static bool enumContains(int v, int toMatchPow)
        {
        ...
        static TexAlignment alterH(int v)
        {
            if (v == 2)
        ...
        static TexAlignment alterV(int v)
        {
            if (v == 2)

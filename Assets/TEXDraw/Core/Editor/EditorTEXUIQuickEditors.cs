...
public class EditorTEXUIQuickEditors : EditorWindow
{
    ...
    static GUIContent[] insertContext = new GUIContent[] {
    ...
    static GUIContent[] addContext = new GUIContent[] {
        new GUIContent("Duplicate"),
    ...
    void GUIHandleFitter (GameObject obj)
    {
            EditorGUI.BeginChangeCheck();
